...
function startCounter(timer, countDownDate) {
    let runningCounter = setInterval(() => {
        ...
        let timerThresholdDays = parseInt(
            timer.getAttribute("data-threshold-days")
        );
...
$(document).ready(function () {
    ...
    Chocolat(
        document.querySelectorAll("#venue-gallery .chocolat-image"),
        options
    );
    Chocolat(
        document.querySelectorAll("#antwerp-gallery .chocolat-image"),
        options
    );
    Chocolat(
        document.querySelectorAll("#previous-edition-gallery .chocolat-image"),
        options
    );
});
