        ...
        <div class="container mx-auto px-4 pt-16 pb-8">
            <div class="md:flex md:mb-4">
                <div class="md:w-1/3 mb-10 md:mb-0">
                    <img src="{{ asset('/assets/2019/images/logo.svg') }}" class="mb-4 md:mb-6" width="150" alt="{{ config('app.name') }}"><br>
                    ...
                    <ul class="list-reset">
                        @if ($edition->publish_schedule)
                            <li data-scroll class="md:ml-6 md:inline-block mt-4">
                                <a href="{{ route('home', $edition) }}#schedule">schedule</a>
                            </li>
                        @endif

                        <li data-scroll class="md:ml-6 md:inline-block mt-4">
                            <a href="{{ route('home', $edition) }}#speakers">speakers</a>
                        </li>
