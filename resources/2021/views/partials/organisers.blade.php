<div id="organisers" class="container mx-auto px-4 text-gray-600 py-12 md:py-16">
    <h2 class="mb-16 title">Organised by</h2>

    <div class="flex justify-center mb-12">
        <div class="w-1/2 md:w-1/3 lg:w-1/5 text-center mb-8 md:mb-0">
            <p class="mb-3">
            ...
            <p class="tracking-xl-wide">
                <a href="https://twitter.com/freekmurze" class="mr-2"><i class="fab fa-twitter"></i></a>
        ...
        <div class="w-1/2 md:w-1/3 lg:w-1/5 text-center mb-8 md:mb-0">
            ...
            <p class="tracking-xl-wide">
                <a href="https://twitter.com/driesvints" class="mr-2"><i class="fab fa-twitter"></i></a>
                <a href="https://driesvints.com"><i class="fas fa-globe-africa"></i></a>
            </p>
        </div>
        <div class="w-1/2 md:w-1/3 lg:w-1/5 text-center mb-8 md:mb-0">
            <p class="mb-3">
                <a href="https://twitter.com/riasvdv">
                    <img src="https://www.gravatar.com/avatar/5ed104facf3de37c46b122113e934d02?s=200"
                         width="100" class="rounded-full enlarge inline-block" alt="Rias Van der Veken">
                </a>
            </p>
            <p class="mb-3">Rias Van der Veken</p>
            <p class="tracking-xl-wide">
                <a href="https://twitter.com/riasvdv" class="mr-2"><i class="fab fa-twitter"></i></a>
                <a href="https://rias.be"><i class="fas fa-globe-africa"></i></a>
            </p>
        </div>
    </div>
    <div class="text-center">
        <p class="mb-3">
            <a href="https://on3.events">
                <img src="{{ asset('/assets/2021/images/on3.png') }}"
