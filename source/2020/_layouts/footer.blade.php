        ...
        <div class="container pt-16 pb-8">
            <div class="md:flex md:mb-4">
                <div class="md:w-1/3 mb-10 md:mb-0">
                    <img src="{{ $page->fseu20['baseUrl'] }}assets/images/logo.svg" class="mb-4 md:mb-6" width="150" alt="Full Stack Europe"><br>
                    7, 8 & 9 October 2020 - {{ $page->fseu20['venue'] }}
                </div>
                <div class="relative md:w-2/3 md:text-right">
                    <ul class="list-reset">
                        <li class="md:ml-6 md:inline-block mb-4">
                            <a data-scroll href="{{ $page->fseu20['baseUrl'] }}#speakers">speakers</a>
                        </li>
                        <li data-scroll class="md:ml-6 md:inline-block mb-4"><a href="{{ $page->fseu20['baseUrl'] }}#venue">venue</a></li>
                        <li data-scroll class="md:ml-6 md:inline-block mb-4"><a href="{{ $page->fseu20['baseUrl'] }}#sponsors">sponsors</a></li>
                        <li class="md:ml-6 md:inline-block mb-4">
                            <a data-scroll href="{{ $page->fseu20['baseUrl'] }}#newsletter">newsletter</a>
                        </li>
                        <li class="md:ml-6 md:inline-block mb-4">
                            <a href="{{ $page->fseu20['baseUrl'] }}diversity">diversity</a>
                        </li>
                        <li class="md:ml-6 md:inline-block mb-4">
                            <a href="{{ $page->fseu20['baseUrl'] }}code-of-conduct">code of conduct</a>
                        </li>
                        <li class="md:ml-6 md:inline-block mb-4">
                            <a href="{{ $page->fseu20['baseUrl'] }}#2019-edition">2019</a>
                        </li>
