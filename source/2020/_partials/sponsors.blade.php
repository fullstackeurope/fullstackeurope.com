...
{{--                @include('2020._partials._sponsor', ['large' => true])--}}
{{--            </div>--}}
...
{{--                @include('2020._partials._sponsor', ['name' => 'MongoDB', 'image' => 'mongodb', 'link' => 'https://www.mongodb.com'])--}}
{{--            </div>--}}
            {{--            <div class="md:w-1/4 md:px-4 mb-4 md:mb-0">--}}
            {{--                @include('2020._partials._sponsor')--}}
            {{--            </div>--}}
            {{--            <div class="md:w-1/4 md:px-4 mb-4 md:mb-0">--}}
            {{--                @include('2020._partials._sponsor')--}}
            {{--            </div>--}}
...
{{--        <div class="md:flex py-4 md:py-8 mb-4">--}}
            ...
            {{--            </div>--}}
            {{--            <div class="md:w-1/4 md:px-4 mb-4 md:mb-0">--}}
            {{--                @include('2020._partials._sponsor', ['name' => 'Think Tomorrow', 'image' => 'think-tomorrow', 'link' => 'https://thinktomorrow.be'])--}}
            {{--            </div>--}}
            {{--            <div class="md:w-1/4 md:px-4 mb-4 md:mb-0">--}}
            {{--                @include('2020._partials._sponsor', ['name' => 'PHPro', 'image' => 'phpro', 'link' => 'https://www.phpro.be'])--}}
            {{--            </div>--}}
            {{--            <div class="md:w-1/4 md:pl-8">--}}
            {{--                @include('2020._partials._sponsor', ['name' => 'Combell', 'image' => 'combell', 'link' => 'https://www.combell.com', 'bg' => 'bg-white'])--}}
            {{--            </div>--}}
{{--        </div>--}}
