...
/***/ "./source/2020/_assets/js/main.js":
/*!****************************************!*\
  !*** ./source/2020/_assets/js/main.js ***!
  \****************************************/
/*! no exports provided */
...
/* harmony import */ var chocolat__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! chocolat */ "./node_modules/chocolat/dist/js/jquery.chocolat.js");
/* harmony import */ var chocolat__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(chocolat__WEBPACK_IMPORTED_MODULE_1__);
...
/* harmony import */ var anchor_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! anchor-js */ "./node_modules/anchor-js/anchor.js");
/* harmony import */ var anchor_js__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(anchor_js__WEBPACK_IMPORTED_MODULE_3__);



 // Navigation scroll

new smooth_scroll__WEBPACK_IMPORTED_MODULE_2___default.a('a[href*="#"]', {// header: '[data-scroll-header]',
  // offset: 25,
});
document.addEventListener('scrollStart', closeNav, false); // Mobile navigation toggle
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()('#show-nav').on('click touchdown', toggleNav);
jquery__WEBPACK_IMPORTED_MODULE_0___default()('#hide-nav').on('click touchdown', toggleNav); // Toggle header background
...
function toggleHeaderBackground() {
  ...
  if (window.pageYOffset >= 50 || !navigation.classList.contains("hidden") || document.body.classList.contains('content-page')) {
...
for (var i = 0; i < timers.length; i++) {
  var timer = timers[i];
  var timestamp = timer.getAttribute('data-expires');
...
function startCounter(timer, countDownDate) {
  var runningCounter = setInterval(function () {
    ...
    var timerThresholdDays = parseInt(timer.getAttribute('data-threshold-days'));
    ...
    var daysLeft = timerCalculateDays(timeDistance);
    ...
    var days = timer.getElementsByClassName('days')[0];
    days.innerHTML = daysLeft;
    var hours = timer.getElementsByClassName('hours')[0];
    hours.innerHTML = formatCounter(Math.floor(timeDistance % (1000 * 60 * 60 * 24) / (1000 * 60 * 60)));
    var minutes = timer.getElementsByClassName('minutes')[0];
    minutes.innerHTML = formatCounter(Math.floor(timeDistance % (1000 * 60 * 60) / (1000 * 60)));
    var seconds = timer.getElementsByClassName('seconds')[0];
...
jquery__WEBPACK_IMPORTED_MODULE_0___default.a.fn.Chocolat = chocolat__WEBPACK_IMPORTED_MODULE_1___default.a;
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).ready(function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.venue-gallery').Chocolat({
    enableZoom: false,
    loop: true
  });
}); // Anchor Links

var anchors = new anchor_js__WEBPACK_IMPORTED_MODULE_3___default.a({
  placement: "left"
});
anchors.add('#page h2');
anchors.add('#page h3'); // Schedule Navigation
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()('#schedule-nav-day-1').on('click', function (e) {
  e.preventDefault();
  showDayOne();
});
jquery__WEBPACK_IMPORTED_MODULE_0___default()('#schedule-nav-day-2').on('click', function (e) {
  e.preventDefault();
  showDayTwo();
});

function showDayOne() {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#schedule-nav-day-1').addClass('primary-gradient');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#schedule-nav-day-2').removeClass('primary-gradient');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#schedule-day-2').hide();
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#schedule-day-1').show();
}

function showDayTwo() {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#schedule-nav-day-1').removeClass('primary-gradient');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#schedule-nav-day-2').addClass('primary-gradient');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#schedule-day-1').hide();
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#schedule-day-2').show();
}

/***/ }),

/***/ "./source/2020/_assets/sass/main.scss":
/*!********************************************!*\
  !*** ./source/2020/_assets/sass/main.scss ***!
  \********************************************/
/*! no static exports found */
...
/***/ 0:
/*!***********************************************************************************!*\
  !*** multi ./source/2020/_assets/js/main.js ./source/2020/_assets/sass/main.scss ***!
  \***********************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! /Users/driesvints/Sites/fullstackeurope.com/source/2020/_assets/js/main.js */"./source/2020/_assets/js/main.js");
module.exports = __webpack_require__(/*! /Users/driesvints/Sites/fullstackeurope.com/source/2020/_assets/sass/main.scss */"./source/2020/_assets/sass/main.scss");
