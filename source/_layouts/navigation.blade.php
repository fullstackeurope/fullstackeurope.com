<div id="navigation" class="lg:w-4/5 mt-10 lg:mt-0 lg:flex lg:flex-col lg:justify-center hidden lg:block lg:text-right">
    <nav>
        <ul class="list-reset">
            ...
            <li class="mb-8 lg:mb-0 lg:mt-4 xl:mt-0 lg:mr-6 lg:inline-block">
