<div id="sponsors" class="bg-grey-lighter text-grey-darker py-12 md:py-16">
    <div class="container">
        <div class="md:flex text-center">
            <div class="md:w-1/2">
                <h3 class="pre-title md:text-left">Meet our sponsors</h3>
                <h2 class="title md:text-left md:mb-0">Become Part Of The Stack</h2>
            </div>
        ...
        {{--<div class="md:flex text-center pb-10 md:pb-0">--}}
            {{--<div class="md:w-1/2">--}}
                ...
                {{--<h2 class="title md:text-left">We're in Good Company</h2>--}}
            {{--</div>--}}
            {{--<div class="md:w-1/2 text-left md:text-right text-lg md:pt-6">--}}
                {{--<a class="apply font-noway-medium block" href="mailto:hello@fullstackeurope.com?subject=We want to sponsor!">--}}
                    {{--Apply as sponsor <span class="float-right md:float-none md:ml-4">&rsaquo;</span>--}}
